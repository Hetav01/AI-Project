# Utility file for defining small functions and methods to be used in main

import torch 
import numpy as np

#defining class Rollouts for noting all the states taking part as elevator
#moves forwards 
...
# Function to check if all the requests are served
def is_finish(state):
...
# State Preprocessing Function for analysing the previous states
